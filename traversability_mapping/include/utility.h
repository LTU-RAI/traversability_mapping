...
// Global Map Params
extern const int globalMapUpdateLength = 40;//cube dimansion of area that is updated in global map around robot (meters)
extern const int globalMapArrayLength=mapArrayLength*mapCubeLength/mapResolution;
// Filter Ring Params
